...
这里存放的是项目在计划管理探索阶段形成的过程文档。

这些文档的价值在于：

1. 记录当时如何设计 GitHub Project / WBS / issue tree
2. 为后续回溯“为什么这样管理计划”提供证据
3. 保留迁移与试运行的历史上下文
...
1. [03-研发总览看板](/home/wgw/CodexProject/NodeConsoleApp2/NodeConsoleApp2/DOC/CodexAnylyse/计划管理归档/03-研发总览看板.md)
2. [04-GitHub-Projects使用说明](/home/wgw/CodexProject/NodeConsoleApp2/NodeConsoleApp2/DOC/CodexAnylyse/计划管理归档/04-GitHub-Projects使用说明.md)
...
7. [09-A4-执行树拆分与Project同步记录](/home/wgw/CodexProject/NodeConsoleApp2/NodeConsoleApp2/DOC/CodexAnylyse/计划管理归档/09-A4-执行树拆分与Project同步记录.md)
