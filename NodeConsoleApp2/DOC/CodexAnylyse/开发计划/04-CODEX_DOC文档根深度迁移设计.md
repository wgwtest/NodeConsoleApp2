...
| 原路径 | 目标路径 | 迁移说明 |
| --- | --- | --- |
| `design/UI_design.md` | `DOC/CODEX_DOC/02_设计说明/UI_design.md` | UI 总体设计，保留原名 |
| `design/battle_scene_proposal.md` | `DOC/CODEX_DOC/02_设计说明/battle_scene_proposal.md` | 战斗场景方案设计，保留原名 |
| `design/buff_design.md` | `DOC/CODEX_DOC/02_设计说明/buff_design.md` | Buff 体系设计，保留原名 |
| `design/buff_editor_design.md` | `DOC/CODEX_DOC/02_设计说明/buff_editor_design.md` | Buff 编辑器设计，保留原名 |
| `design/core_engine.md` | `DOC/CODEX_DOC/02_设计说明/core_engine.md` | 核心引擎设计，保留原名 |
| `design/data_design.md` | `DOC/CODEX_DOC/02_设计说明/data_design.md` | 数据结构设计，保留原名 |
| `design/enemy_design.md` | `DOC/CODEX_DOC/02_设计说明/enemy_design.md` | 敌人设计，保留原名 |
| `design/item_design.md` | `DOC/CODEX_DOC/02_设计说明/item_design.md` | 道具设计，保留原名 |
| `design/level_design.md` | `DOC/CODEX_DOC/02_设计说明/level_design.md` | 关卡设计，保留原名 |
| `design/skill_balance_design.md` | `DOC/CODEX_DOC/02_设计说明/skill_balance_design.md` | 技能平衡设计，保留原名 |
| `design/skill_design.md` | `DOC/CODEX_DOC/02_设计说明/skill_design.md` | 技能体系设计，保留原名 |
| `design/skill_design_brainStorm.md` | `DOC/CODEX_DOC/02_设计说明/skill_design_brainStorm.md` | 技能头脑风暴设计，保留原名 |
| `design/skill_editor_design.md` | `DOC/CODEX_DOC/02_设计说明/skill_editor_design.md` | 技能编辑器设计，保留原名 |
| `design/skill_planning_design.md` | `DOC/CODEX_DOC/02_设计说明/skill_planning_design.md` | 技能规划设计，保留原名 |
| `design/skill_test_design.md` | `DOC/CODEX_DOC/02_设计说明/skill_test_design.md` | 技能测试设计，保留原名 |
| `design/timeline_UI_design.md` | `DOC/CODEX_DOC/02_设计说明/timeline_UI_design.md` | 时间线 UI 设计，保留原名 |
| `design/timeline_design.md` | `DOC/CODEX_DOC/02_设计说明/timeline_design.md` | 时间线机制设计，保留原名 |
