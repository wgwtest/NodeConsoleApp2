...
1. `#89 / WBS-4.1.3`
   ...
   - 说明：本节点把战斗页、游戏菜单、关卡选择页的关键信息收敛到统一摘要骨架，当前人工验收重点是摘要条是否真的帮助理解“现在该做什么”。
2. `#98 / WBS-3.3.3`
   - 状态：`待验收`
   - 清单：
   ...
   - 说明：本节点用于把技能异常正式纳入“分批修复 + 状态回写”闭环，当前人工验收重点是首批结构异常是否已收口，以及两个测试页是否已能明确解释本节点范围。
3. `#97 / WBS-4.3.7`
   - 状态：`待验收`
   - 清单：
   ...
   - 说明：本节点把对战展示参数提升为正式配置资产，并提供独立配置器、probe 读数与主流程消费入口。
