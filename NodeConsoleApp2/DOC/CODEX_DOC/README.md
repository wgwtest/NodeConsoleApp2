...
| `02_设计说明` | 稳定设计文档 | `00_总纲`、主游戏流程、战斗运行时、关卡地图与编辑器、技能系统与编辑器、Buff 系统与编辑器、数据存档与内容契约、UI 与交互基线 |
...
2. 原设计目录中的稳定文档已整体迁入 `DOC/CODEX_DOC/02_设计说明/`，并在 2026-05-21 重构为 `00_总纲 + S1-S7 子系统目录`。
