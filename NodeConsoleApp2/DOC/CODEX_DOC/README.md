...
| `02_设计说明` | 稳定设计文档 | `00_总纲`、主游戏流程、战斗运行时、关卡地图与编辑器、技能系统与编辑器、Buff 系统与编辑器、敌人系统与编辑器、数据存档与内容契约、UI 与交互基线 |
...
2. 原设计目录中的稳定文档已整体迁入 `DOC/CODEX_DOC/02_设计说明/`；当前设计说明目录为 `00_总纲 + S1-S8 子系统目录`，其中 `S6_敌人系统与编辑器` 位于 Buff 系统之后、数据存档与内容契约之前。
...
6. [设计说明子系统化重构记录](/home/wgw/CodexProject/NodeConsoleApp2/NodeConsoleApp2/DOC/CODEX_DOC/06_过程文档/06_文档迁移记录/2026-05-21-设计说明子系统化重构记录.md)
