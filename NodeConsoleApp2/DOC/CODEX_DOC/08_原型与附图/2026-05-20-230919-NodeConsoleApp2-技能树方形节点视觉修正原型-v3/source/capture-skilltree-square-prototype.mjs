...
async function main() {
	...
	try {
		...
		await screenshot(page, '01-current-global-1920x1080.png');
		await evaluate(page, `(() => {
		...
		await sleep(400);
		await screenshot(page, '02-current-selected-block-1920x1080.png');

		await applyPrototype(page);
		await sleep(500);
		await screenshot(page, '03-prototype-final-layout-1920x1080.png');
