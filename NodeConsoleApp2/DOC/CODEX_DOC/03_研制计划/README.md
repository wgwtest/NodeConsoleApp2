...
2. 当前正式阶段节点：`#37 / 阶段B`
3. 当前正式未关闭工作包：`#67 / B3`
4. 当前主执行节点：`#67 / B3（#66 / #68 已自测，待人工验收）`
5. 当前并行 Prep 工作包：
   - `#29 / C1 技能树与构筑`
   - `#30 / C2 内容扩充`
   - `#70 / D3 对战演出与动画展示层`
...
11. 当前主执行拆分：
   - `#66 / B3.1 自动存档槽位与入口语义收口`
   - `#68 / B3.2 统一保存协调层与存档回归补强`
12. 当前并行启动线：
   - `#29 / C1 技能树与构筑`
   - `#30 / C2 内容扩充`
   - `#70 / D3 对战演出与动画展示层`
13. 阶段 B 当前已完成且已验收的既有工作包：
   - `#26 / B1`
   - `#27 / B2`
14. 阶段 C 当前已落地的叶子节点：
...
3. 当前正式阶段 `#37` 已因 `#67 / B3` 重开：`2026-04-07`
