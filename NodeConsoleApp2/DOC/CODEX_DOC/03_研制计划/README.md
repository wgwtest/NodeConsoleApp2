...
1. WBS 根节点：`#13`
2. 当前正式阶段节点：`#14 / 阶段A`
3. 当前正式未关闭工作包：`#15 / A1`、`#16 / A2`
4. 当前主执行节点：`#65 / C1.3`
5. 当前并行 Prep 工作包：`#29 / C1 技能树与构筑`
6. 当前待人工验收节点：
   - `#18 / A1.1`
   - `#19 / A1.2`
   - `#20 / A2.1`
...
3. 当前正式阶段 `#14` 目标评估日：`2026-04-03`
4. 当前并行 Prep 包 `#29` 已进入叶子执行：`2026-04-06`
5. `#29 / C1` 当前已落地叶子：`#63 ~ #65`
6. GitHub Project Roadmap 地址：
