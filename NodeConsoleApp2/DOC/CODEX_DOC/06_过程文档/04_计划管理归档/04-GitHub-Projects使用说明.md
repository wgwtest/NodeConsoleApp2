...
1. 这是面向人类查看进度的展示层
2. 本地 `DOC/CODEX_DOC/03_研制计划/` 仍然是 AI 和工程执行的事实源
...
1. 方案定义：
   - [05-严格树形任务分解与GitHub-Issue-Tree方案](/home/wgw/CodexProject/NodeConsoleApp2/NodeConsoleApp2/DOC/CODEX_DOC/06_过程文档/04_计划管理归档/05-严格树形任务分解与GitHub-Issue-Tree方案.md)
2. 执行记录：
...
1. 先看 [06-阶段A-Issue-Tree初始迁移记录](/home/wgw/CodexProject/NodeConsoleApp2/NodeConsoleApp2/DOC/CODEX_DOC/06_过程文档/04_计划管理归档/06-阶段A-Issue-Tree初始迁移记录.md)
...
1. 总体事实源：
   - [01-WBS-L0-NodeConsoleApp2-可交付版本研发总纲](/home/wgw/CodexProject/NodeConsoleApp2/NodeConsoleApp2/DOC/CODEX_DOC/03_研制计划/01-WBS-L0-NodeConsoleApp2-可交付版本研发总纲.md)
2. 当前激活阶段计划：
   - [02-WBS-L1-阶段A-战斗竖切闭环](/home/wgw/CodexProject/NodeConsoleApp2/NodeConsoleApp2/DOC/CODEX_DOC/03_研制计划/02-WBS-L1-阶段A-战斗竖切闭环.md)
3. 人类总览文档：
   - [03-研发总览看板](/home/wgw/CodexProject/NodeConsoleApp2/NodeConsoleApp2/DOC/CODEX_DOC/06_过程文档/04_计划管理归档/03-研发总览看板.md)
4. 严格树方案：
   - [05-严格树形任务分解与GitHub-Issue-Tree方案](/home/wgw/CodexProject/NodeConsoleApp2/NodeConsoleApp2/DOC/CODEX_DOC/06_过程文档/04_计划管理归档/05-严格树形任务分解与GitHub-Issue-Tree方案.md)
5. 阶段 A 迁移记录：
   - [06-阶段A-Issue-Tree初始迁移记录](/home/wgw/CodexProject/NodeConsoleApp2/NodeConsoleApp2/DOC/CODEX_DOC/06_过程文档/04_计划管理归档/06-阶段A-Issue-Tree初始迁移记录.md)
